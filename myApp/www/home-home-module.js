...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-header [translucent]=\"true\">\n  <ion-toolbar>\n    <ion-title>\n      Blank\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content [fullscreen]=\"true\">\n  <ion-header collapse=\"condense\">\n    <ion-toolbar>\n      <ion-title size=\"large\">Blank</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-item>\n    <ion-input [(ngModel)]=\"downloadUrl\"></ion-input>\n  </ion-item>\n\n  <ion-button color=\"light\" (click)=\"downloadFile()\" [disabled]=\"downloadUrl == ''\" expand=\"full\">\n    <ion-icon slot=\"start\" name=\"download\"></ion-icon>\n    Download From Url\n  </ion-button>\n\n  <ion-row>\n    <ion-col size=\"4\">\n      <ion-button color=\"light\" (click)=\"downloadPDF1()\" expand=\"full\">PDF Grande</ion-button>\n    </ion-col>\n\n    <ion-col size=\"4\">\n      <ion-button color=\"light\" (click)=\"downloadPDF2()\" expand=\"full\">Video Grande</ion-button>\n    </ion-col>\n\n    <ion-col size=\"4\">\n      <ion-button color=\"light\" (click)=\"downloadPDF3()\" expand=\"full\">Imagem Grande</ion-button>\n    </ion-col>\n\n    <ion-col size=\"4\">\n      <ion-button color=\"light\" (click)=\"downloadPDF4()\" expand=\"full\">Audio Grande</ion-button>\n    </ion-col>\n  </ion-row>\n  \n</ion-content>\n");
...
const { FileSystem, Storage } = _capacitor_core__WEBPACK_IMPORTED_MODULE_6__["Plugins"];
const FILE_KEY = 'files';
let HomePage = class HomePage {
    //{}
    constructor(nativeHTTP, fileOpener, file, browser, platform, transfer) {
        ...
        this.pdfUrl = 'https://file-examples-com.github.io/uploads/2017/10/file-sample_150kB.pdf';
        this.videoUrl = 'https://file-examples-com.github.io/uploads/2017/04/file_example_MP4_480_1_5MG.mp4';
        this.imageUrl = 'https://file-examples-com.github.io/uploads/2017/10/file_example_PNG_500kB.png';
        this.downloadUrl = '';
        this.mYFiles = [];
    ...
    openPDF(url) {
        ...
        if (this.platform.is('android')) {
            ...
            //Attempt with IAB
            let browser = this.browser.create(url, '_blank', 'location=yes,' +
                'toolbar=yes,' +
    ...
    download(fileUrl, type) {
        ...
        if (this.platform.is('ios')) {
            ...
            if (type == 'audio') {
                this.openAudio(fileUrl.audioUrl);
            }
        }
        switch (type) {
            case "book":
    ...
    downloadPDF(path, url) {
        if (!this.platform.is('cordova')) {
            ...
            transfer.download(url, path + filename + ".pdf", true).then(entry => {
